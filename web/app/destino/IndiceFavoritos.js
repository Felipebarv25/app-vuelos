  ...
  return (
    <section className="mx-auto max-w-6xl px-6 py-4">
      <div className="flex items-center gap-2">
        <span className="rounded-full bg-rose-100 p-2 text-rose-600 dark:bg-rose-900/30 dark:text-rose-300">
          <Icono nombre="heart" size={16} />
        </span>
        <h2 className="text-lg font-extrabold text-marca-900 dark:text-marca-300">
          Tus favoritos
          <span className="ml-2 rounded-full bg-rose-100 px-2 py-0.5 align-middle text-[11px] font-bold text-rose-700 dark:bg-rose-900/30 dark:text-rose-300">
            {favs.length}
          </span>
        </h2>
      </div>
